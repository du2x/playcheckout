...
Version: 1.2 · Status: Gray-box + stack decisions locked · Owner: —
...
- FR-14 HUD shows exactly two things: coverage % and shift timer. No feeds, no player
       list, no other oracles.
...
counts, catch/accusation wins at low counts. No dial changes pre-build.
